    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center mx-auto mb-5" data-wow-delay="0.1s" style="max-width: 600px;">
                ...
                <p>
          Once you have made an enquiry about one of our items we will contact you via email or telephone to discuss how you wish to receive the item. We able to accommodate either delivery or collect. Once arrangements have been made we will send an invoice for payment via bank transfer.
                ...
                <p>
We’re happy to work with you on postage, if you have a trusted courier then we simply ask for them to contact us to make arrangements. Alternatively we can offer a price for postage of smaller items through a standard courier or larger item delivery through one of our tried and trusted courier services.
